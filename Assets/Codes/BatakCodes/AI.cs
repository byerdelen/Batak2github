...
public class AI : MonoBehaviour
{
    ...
    IEnumerator addinfo(Card tempcard)
    {
        ...
        if (cards.Count == 13)
        {
            handtotake = Cardstatic.calculatehandsbatak(engine.powercardtype, cards);
            ihale.text = "" + handtotake;
            engine.aims[playerturn] = handtotake;
            if (handtotake > 9)
                engine.pointlabels[playerturn].fontSize = 25;
            engine.pointlabels[playerturn].text = "0/" + handtotake ;
        }
