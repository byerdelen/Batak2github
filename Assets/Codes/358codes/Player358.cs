...
public class Player358 : MonoBehaviour
{

    public    bool canplay = false;
    public bool cardexchange = false;
    ...
    public void choosecardtoexchange(bool val)
    {
        if (val)
        {
            cardexchange = true;
    ...
    public void addinfo(Card tempcard)
    {
        cards.Add(tempcard);
        tempcard.rend.GetComponent<SpriteRenderer>().sprite = tempcard.normal;
